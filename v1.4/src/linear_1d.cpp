...
{
    dlr::Linear1d<float, 0, 0> ( out_data
             , in_data
             , weight
             , bias
             , out_size
...
{
    dlr::Linear1d<double, 0, 0> ( out_data
             , in_data
             , weight
             , bias
             , out_size
...
{
    dlr::Linear1d<float, 1, 0> ( out_data
             , in_data
             , weight
             , bias
             , out_size
...
{
    dlr::Linear1d<double, 1, 0> ( out_data
             , in_data
             , weight
             , bias
             , out_size
